                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                    ...
                    <div className="border-t border-gray-100 pt-4 mb-6">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-bold text-xl text-[#D92D20]">Rp {totalPrice.toLocaleString("id-ID")}</span>
                        </div>
                    </div>

                    <Button className="w-full bg-[#D92D20] hover:bg-[#b91c1c] h-12 text-md font-bold" asChild>
                        <Link href="/checkout">
