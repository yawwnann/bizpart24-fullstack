      ...
      <Card className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl">
        <div className="text-center mb-8">
            <div className="flex justify-center mb-6">
                <img src="/logo.png" alt="BIZSPAREPART24 Logo" className="h-16 w-auto object-contain" />
            </div>
            <h1 className="text-2xl font-bold text-gray-900">Admin Portal</h1>
            <p className="text-gray-500 text-sm">Masuk untuk mengelola BIZSPAREPART24</p>
        </div>
        ...
        <div className="mt-8 text-center">
            <p className="text-xs text-gray-400">
                &copy; 2024 BIZSPAREPART24 Admin System
            </p>
        </div>
      </Card>
    </main>
